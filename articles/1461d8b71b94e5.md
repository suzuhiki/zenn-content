...
![チャートの設定](/images/notion_chart_setting.png =400x)
*チャートの設定*
![チャート設定の「その他のスタイルオプション」](/images/notion_chart_detail_setting.png =400x)
